...
################################################################
# This is a generated script based on design: bd_ac0c
#
...
proc create_hier_cell_s00_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SEG002_SIZE {22} \
   CONFIG.SEG002_SUPPORTS_READ {1} \
   CONFIG.SEG002_SUPPORTS_WRITE {1} \
   CONFIG.SUPPORTS_NARROW {0} \
   CONFIG.S_ARUSER_WIDTH {4} \
   CONFIG.S_AWUSER_WIDTH {4} \
   CONFIG.S_BUSER_WIDTH {4} \
...
proc create_hier_cell_m00_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MAX_WUSER_BITS_PER_BYTE {0} \
   CONFIG.MEP_IDENTIFIER_WIDTH {1} \
   CONFIG.M_ARUSER_WIDTH {4} \
   CONFIG.M_AWUSER_WIDTH {4} \
   CONFIG.M_BUSER_WIDTH {4} \
   CONFIG.M_ID_WIDTH {0} \
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SC_ARUSER_WIDTH {4} \
   CONFIG.SC_AWUSER_WIDTH {4} \
   CONFIG.SC_BUSER_WIDTH {4} \
