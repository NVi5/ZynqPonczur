...
void vertex_process_software (int32_t input[4], int32_t output[4], int32_t Rm[4][4]) {
	output[0] = Rm[0][0] * input[0] + Rm[0][1] * input[1] + Rm[0][2] * input[2] + Rm[0][3] * input[3];
	output[1] = Rm[1][0] * input[0] + Rm[1][1] * input[1] + Rm[1][2] * input[2] + Rm[1][3] * input[3];
	output[2] = Rm[2][0] * input[0] + Rm[2][1] * input[1] + Rm[2][2] * input[2] + Rm[2][3] * input[3];
	output[3] = Rm[3][0] * input[0] + Rm[3][1] * input[1] + Rm[3][2] * input[2] + Rm[3][3] * input[3];
	output[0] = output[0] >> 14;
	output[1] = output[1] >> 14;
	output[2] = output[2] >> 14;
	output[3] = output[3] >> 14;
}
